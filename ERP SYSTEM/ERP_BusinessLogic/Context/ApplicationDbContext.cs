...
namespace ERP_BusinessLogic.Context
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasMany(od => od.ManufacturingOrderDetails).WithOne().OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<TbOrder_Supplier>().HasMany(od => od.OrderedMaterials).WithOne().OnDelete(DeleteBehavior.Restrict);
