...
namespace ERP_BusinessLogic.Services
{
    public class DistributionOrderService : IDistributionOrderService
    {
        ...
        public async Task<TbDistributionOrder> CreateDistributionOrder(int distributorId, List<OrderedFinishedProductParameters> orderedProducts)
        {
            ...
            var order = new TbDistributionOrder(distributorId, totalQty, subtotal, subtotal, DateTime.UtcNow.AddDays(3), 1, orderDetailsList);
