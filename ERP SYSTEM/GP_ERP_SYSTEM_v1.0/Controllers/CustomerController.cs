...
namespace GP_ERP_SYSTEM_v1._0.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddCustomerProfile([FromBody] AddCustomerDTO customerDto)
        {
            ...
            try
            {
                _unitOfWork.Customer.InsertAsync(_mapper.Map<TbCustomer>(customerDto));
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> EditCustomerProfile(int id, [FromBody] AddCustomerDTO customerDto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            try
            {
                ...
                _mapper.Map(customerDto, customerIdToUpdate);
