...
const handleChange = (e) =>
{
   ...
   setEmpdata(hrlData);
   console.log("empdata",empdata.hrid)
}
...
async function getEmployee ()
{
  ...
  if (emp) {
    setEmpdata({
      ...
      taxWithholding: emp.taxWithholding || 0,
      hoursWorked: emp.hoursWorked || 0,
      dateOfJoining: emp.dateOfJoining || "2023-05-17T19:43:58.755Z",
      attendenceTime: emp.attendenceTime || "2023-05-17T19:43:58.755Z",
      holidays: emp.holidays || "2023-05-17T19:43:58.755Z",
    ...
    <div className="hr">
      ...
      <div className="hrTop">
          ...
          <form className="hrForm"  onSubmit={handleSubmit}>
              ...
              <input type="number" onChange={handleChange} placeholder="hrid" name="hrid" value={empdata.hrid}/>
          ...
          <div className="hrTopRight">
              ...
              <p className="hrName"><span className="spanform">hrid:</span> {empdata.hrid}</p>
