      ...
      <div className="productinventoryTop">
          ...
          <div className="productinventoryFormLeft">
            <label>
              <input 
                type="checkbox" 
                onChange={(e) => handleChange({target: {name: 'hasReachedROP', value: e.target.checked}})} 
                name="hasReachedROP" 
                checked={proinventorydata.hasReachedROP}
              />
              Has Reached Reordering Point
            </label>
          </div>
          ...
          <div className="productinventoryTopRight">
              ...
              <p className="paddorder"><span className="spanform">hasReachedROP:</span> {proinventorydata.hasReachedROP ? 'Yes' : 'No'}</p>
