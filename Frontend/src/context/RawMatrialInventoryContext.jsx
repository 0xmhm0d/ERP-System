...
export function RawMatrialInventoryContextProvider({children})
{
    ...
    {
     const allRawMatrialInventory = await axios.get(`https://localhost:5001/api/GetAllRawMaterialsInventory`);
    ...
    {
           const rawmatrialinventoryObject = await axios.get(`https://localhost:5001/api/GetRawMaterialInventoryById/${id}`);
           return rawmatrialinventoryObject ;
          
    }
 async function deleteRawMatrialInventory(id)
 {
        const deletedRawMatrialInventory = await axios.delete(`https://localhost:5001/api/DeleteRawMaterialFromInventory/${id}`);
...
// getAllRawMatrialInventory();
      ...
      {
             const updateRawmatrialInventory = await axios.put(`https://localhost:5001/api/UpdateRawMaterialInInventory`,updatedData);
