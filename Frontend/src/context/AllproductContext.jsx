...
export function AllproductContextProvider({children})
{
    ...
    {
     const allproduct = await axios.get(`https://localhost:5001/api/GetAllProducts`);
...
//      setData(allproduct.data);
    ...
    {
           const productObject = await axios.get(`https://localhost:5001/api/GetProductById/${id}`);
           return productObject ;
          
    }
 async function deleteproduct(id)
 {
        const deletedproduct = await axios.delete(`https://localhost:5001/api/DeleteProduct?id=${id}`);
    ...
    const handleDelete = (id) => {
      ...
      {
             const updatedProduct = await axios.put(`https://localhost:5001/api/UpdateProduct/${id}`,updatedData);
